...
export default function AboutPage() {
  ...
  return (
    <div className={styles.page}>
      <Helmet>
        <link rel="canonical" href="https://www.sketchonthoughts.com/about" />
        <title>About | Sketch on Thoughts (SOT Designs)</title>
        <meta name="description" content="Learn about Sketch on Thoughts (SOT Designs), an architecture and interior design studio in Tirur, Kerala, led by Ar. Mohammed Ali (CET)." />
      </Helmet>
      <Header />
